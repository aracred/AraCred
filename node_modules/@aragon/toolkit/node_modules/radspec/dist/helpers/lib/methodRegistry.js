...
const REGISTRY_LOOKUP_ABI=[{constant:!0,inputs:[{name:"",type:"bytes4"}],name:"entries",outputs:[{name:"",type:"string"}],payable:!1,type:"function"}],REGISTRY_MAP={1:"0x44691B39d1a75dC4E0A0346CBB15E310e6ED1E86"};// networkId -> registry address
