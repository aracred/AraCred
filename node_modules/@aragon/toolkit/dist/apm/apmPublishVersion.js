 ...
 */
var _default = async (web3, manager, appId, version, provider, directory, contract, from, apmOptions) => {
  const apm = await (0, _apm.default)(web3, apmOptions);
  return apm.publishVersion(manager, appId, version, provider, directory, contract, from);
};

exports.default = _default;
//# sourceMappingURL=apmPublishVersion.js.map