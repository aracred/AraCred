...
exports.formatAclPermissions = formatAclPermissions;
exports.formatAclPermission = exports.flattenAclPermissions = void 0;
...
exports.flattenAclPermissions = flattenAclPermissions;
...
exports.formatAclPermission = formatAclPermission;

function formatAclPermissions(permissions, apps, knownApps, knownRoles) {
  return flattenAclPermissions(permissions).map(aclPermission => formatAclPermission(aclPermission, apps, knownApps, knownRoles));
}
//# sourceMappingURL=viewFormatter.js.map